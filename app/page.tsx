        ...
        <div className="relative z-10 flex min-w-0 flex-1 items-center pt-1 lg:pt-2">
          <div className="min-w-0 max-w-6xl lg:pl-8 xl:pl-14">
            ...
            <div className="mt-6 flex flex-col gap-2.5 sm:mt-8 sm:gap-3 lg:mt-10 [@media_(min-width:900px)_and_(max-width:1280px)_and_(orientation:landscape)]:max-w-[900px] [@media_(min-width:900px)_and_(max-width:1280px)_and_(orientation:landscape)]:flex-row [@media_(min-width:900px)_and_(max-width:1280px)_and_(orientation:landscape)]:flex-wrap [@media_(min-width:900px)_and_(max-width:1280px)_and_(orientation:landscape)]:items-center [@media_(min-width:900px)_and_(max-width:1280px)_and_(orientation:landscape)]:gap-3 [@media_(min-width:1281px)]:grid [@media_(min-width:1281px)]:grid-cols-3 [@media_(min-width:1281px)]:gap-4">
              ...
              <TrackedLink href="/request-cv" eventName="cta_click" eventProps={{ source: "homepage_hero", label: "minta_akses_cv", href_type: "internal" }} data-cta="homepage-request-cv" className="inline-flex min-h-10 max-w-full items-center justify-center rounded-full border border-[#C8A951]/35 bg-[#C8A951]/10 px-5 py-2.5 text-center font-mono text-[0.76rem] font-semibold uppercase tracking-[0.08em] text-[#C8A951] transition hover:bg-[#C8A951]/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D4AF37]/55 focus-visible:ring-offset-2 focus-visible:ring-offset-[#080807] w-full sm:min-h-11 sm:px-7 sm:py-3 sm:text-sm sm:tracking-[0.12em] [@media_(min-width:900px)_and_(max-width:1280px)_and_(orientation:landscape)]:w-auto">Minta Akses CV</TrackedLink>
