  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#080807] font-sans text-[#F4F1EA]">
      ...
      >
        <nav className="relative z-10 flex items-start justify-between gap-8">
          ...
          <div className="hidden items-start gap-8 text-sm font-semibold text-white/78 lg:flex">
            <a className="border-b border-[#C8A951] pb-3 text-[#C8A951] transition duration-300" href="#home">Beranda</a>
          ...
          <a
            ...
            className="hidden rounded-[4px] bg-[#C8A951] px-7 py-3.5 text-sm font-semibold uppercase tracking-[0.08em] text-[#080807] shadow-[0_18px_44px_rgba(200,169,81,0.16)] transition duration-300 hover:-translate-y-0.5 hover:bg-[#D7BD72] md:inline-flex"
          >
            Hubungi Studio
          </a>
        </nav>
        ...
        <div className="relative z-10 grid flex-1 items-center pt-16 lg:grid-cols-[1fr_0.5fr] lg:pt-4">
          <div className="max-w-5xl lg:pl-8 xl:pl-14">
            <p className="mb-7 font-mono text-[10px] font-black uppercase tracking-[0.58em] text-[#C8A951] md:text-[11px]">
            ...
            <h1 className="font-display max-w-5xl text-[clamp(3.3rem,6.4vw,7.05rem)] font-normal uppercase leading-[1.01] tracking-[-0.052em] text-[#F4F1EA] drop-shadow-[0_16px_34px_rgba(0,0,0,0.42)]">
              Desain Sebagai<br />
              <span className="block text-[#C8A951] italic tracking-[-0.065em]">Keputusan</span>
              <span className="block text-[#C8A951] italic tracking-[-0.065em]">Strategis.</span>
            </h1>
            ...
            <div className="mt-12 flex flex-col gap-4 sm:flex-row">
              <a
                href="mailto:eryawanagungtrimuda@gmail.com"
                className="inline-flex min-w-[292px] items-center justify-center rounded-[4px] bg-[#C8A951] px-8 py-4 text-sm font-semibold uppercase tracking-[0.1em] text-[#080807] transition duration-300 hover:-translate-y-0.5 hover:bg-[#D7BD72]"
              >
                Mulai Konsultasi Strategis
              </a>
              <a
                href="#framework"
                className="inline-flex min-w-[250px] items-center justify-center rounded-[4px] border border-white/25 bg-[#11151b]/68 px-8 py-4 text-sm font-semibold uppercase tracking-[0.1em] text-white/82 backdrop-blur transition duration-300 hover:-translate-y-0.5 hover:border-[#C8A951]/45 hover:text-[#C8A951]"
              >
      ...
      <section id="framework" className="relative overflow-hidden bg-[#2D2D2B] px-5 py-20 md:px-10 md:py-24 lg:px-16 lg:py-32">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(200,169,81,0.09),transparent_27%),linear-gradient(180deg,rgba(255,255,255,0.035),transparent_58%)]" />
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mt-18 grid gap-6 md:mt-20 lg:grid-cols-3">
            {framework.map((item) => {
              ...
              return (
                <article key={item.title} className="group border border-white/10 bg-[#262624]/35 p-7 transition duration-300 hover:-translate-y-1 hover:border-[#C8A951]/30 hover:bg-[#2A2A28]/70 md:p-9">
                  <div className="mb-16 flex items-center justify-between">
                    <div className="flex items-baseline gap-3">
                      <span className="font-mono text-xs font-black uppercase tracking-[0.28em] text-white/36">{item.number}</span>
                      <span className="font-mono text-[10px] font-bold uppercase tracking-[0.32em] text-[#C8A951]/75">{item.code}</span>
                    </div>
                    <span className="grid h-12 w-12 place-items-center border border-[#C8A951]/35 text-[#C8A951] transition duration-300 group-hover:border-[#C8A951]/60 group-hover:bg-[#C8A951]/10">
      ...
      <section id="design-decisions" className="relative overflow-hidden bg-[#070707] px-5 py-20 text-white md:px-10 md:py-24 lg:px-16 lg:py-32">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-16 lg:grid-cols-[0.78fr_1.22fr] lg:gap-24">
          <div className="lg:sticky lg:top-28 lg:self-start">
            ...
            <a href="#portfolio" className="group mt-10 inline-flex items-center gap-4 border-b border-[#C8A951]/35 pb-1 font-mono text-[11px] font-black uppercase tracking-[0.18em] text-[#C8A951] transition duration-300 hover:border-white/40 hover:text-white">
          ...
          <div className="space-y-12 lg:pt-3">
            {decisions.map((decision, index) => (
              <article key={decision.title} className="group relative border-l border-white/10 pl-8 transition duration-300 hover:border-[#C8A951]/30 md:pl-10">
                <span className="absolute -left-[5px] top-1 h-2.5 w-2.5 rounded-full bg-[#C8A951]/70 opacity-70 transition duration-300 group-hover:opacity-100" />
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mt-18 grid gap-6 md:mt-20 md:grid-cols-2 lg:grid-cols-4">
            {impacts.map((impact, index) => (
              <div key={impact.label} className="group border border-white/8 bg-white/[0.015] px-6 py-9 text-center transition duration-300 hover:-translate-y-1 hover:border-[#C8A951]/25 hover:bg-white/[0.035]">
                <p className="font-mono text-[10px] font-black uppercase tracking-[0.24em] text-white/28">0{index + 1}</p>
                <div className="mt-8 flex justify-center text-[#C8A951]/62 transition duration-300 group-hover:text-[#C8A951]">
      ...
      <section id="differentiation" className="relative overflow-hidden bg-[#2D2D2B] px-5 py-20 md:px-10 md:py-24 lg:px-16 lg:py-32">
        <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-[#C8A951]/12" />
        <div className="relative mx-auto max-w-7xl">
            ...
            {differentiations.map((item, index) => (
              <article key={item.title} className="group lg:border-l lg:border-white/10 lg:px-10 first:lg:border-l-0 first:lg:pl-0 last:lg:pr-0">
                <div className="flex items-start gap-4">
                  <CheckCircle2 className="mt-1 shrink-0 text-[#C8A951]/85 transition duration-300 group-hover:text-[#C8A951]" size={18} strokeWidth={2.2} />
                  <div>
      ...
      <section id="portfolio" className="relative overflow-hidden bg-[#142030] px-5 py-20 text-white md:px-10 md:py-24 lg:px-16 lg:py-32">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-[1fr_0.42fr] lg:items-center">
            <div>
              <p className="font-mono text-[10px] font-black uppercase tracking-[0.52em] text-[#C8A951] md:text-[11px]">Portfolio Framework</p>
              ...
              <div className="mt-10 flex items-start gap-7">
                <span className="mt-2 h-10 w-px bg-[#C8A951]/50" />
            ...
            <a href="#contact" className="group inline-flex items-center gap-4 justify-self-start border-b border-white/20 pb-1 font-mono text-xs font-black uppercase tracking-[0.18em] text-white/88 transition duration-300 hover:border-[#C8A951]/50 hover:text-[#C8A951] lg:justify-self-end">
              Lihat Semua Karya
            ...
            {portfolioWorks.map((work) => (
              <article key={work.title} className="group relative aspect-[1.18/1] min-h-[360px] overflow-hidden rounded-sm border border-white/8 bg-[#0C0D0F] md:min-h-[440px]">
                <div
                  ...
                  style={{
                    backgroundImage: `radial-gradient(circle at 24% 18%, rgba(200,169,81,0.22), transparent 28%), linear-gradient(135deg, rgba(255,255,255,0.08), rgba(0,0,0,0.2)), url('${work.image}')`,
                  }}
                />
      ...
      <section id="contact" className="relative overflow-hidden bg-[#050505] px-5 py-20 text-white md:px-10 md:py-24 lg:px-16 lg:py-32">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_18%,rgba(200,169,81,0.045),transparent_30%)]" />
        <div className="relative mx-auto max-w-7xl">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <a
              href="mailto:eryawanagungtrimuda@gmail.com"
              className="mt-14 inline-flex min-w-[300px] items-center justify-center rounded-[4px] bg-[#C8A951] px-10 py-5 text-sm font-semibold uppercase tracking-[0.12em] text-[#080807] shadow-[0_22px_50px_rgba(200,169,81,0.14)] transition duration-300 hover:-translate-y-0.5 hover:bg-[#D7BD72] md:min-w-[420px]"
            >
            ...
            <p className="font-signature mt-7 text-4xl leading-none text-[#C8A951]/65 md:text-5xl">— Eryawan Studio</p>
