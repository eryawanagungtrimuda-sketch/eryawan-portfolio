...
export default function KontakPage() {
  return (
    <main className="min-h-screen bg-[#080807] px-4 py-12 font-sans text-[#F4F1EA] sm:px-5 md:px-8 lg:px-12">
      <section className="mx-auto max-w-3xl rounded-2xl border border-white/10 bg-white/[0.02] p-6 sm:p-8 md:p-12">
        ...
        <a href="mailto:eryawanagungtrimuda@gmail.com" className="mt-8 inline-flex min-h-11 max-w-full break-all rounded-full border border-[#D4AF37] bg-[#D4AF37] px-4 py-3 font-mono text-[11px] font-black uppercase tracking-[0.12em] text-black transition hover:bg-[#E2C866] sm:px-6 sm:text-xs sm:tracking-[0.16em]">eryawanagungtrimuda@gmail.com</a>
        <div className="mt-5">
