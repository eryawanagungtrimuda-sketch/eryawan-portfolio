        ...
        <div className="mt-8 border-t border-white/10 pt-6">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <TrackedLink
              ...
              className="inline-flex min-h-11 items-center rounded-full border border-[#D4AF37]/50 bg-[#D4AF37]/10 px-6 py-3 font-mono text-xs font-black uppercase tracking-[0.16em] text-[#D4AF37] transition hover:bg-[#D4AF37]/20"
            >
              Mulai Percakapan
            </TrackedLink>
            <TrackedLink
              ...
              className="inline-flex min-h-11 items-center rounded-full border border-white/14 px-6 py-3 font-mono text-xs font-black uppercase tracking-[0.16em] text-white/66 transition hover:border-[#D4AF37]/40 hover:text-[#D4AF37]"
            >
              Lihat Karya
            </TrackedLink>
            <TrackedLink
