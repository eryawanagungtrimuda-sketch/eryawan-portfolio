        ...
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-col gap-6 border-b border-white/10 pb-8 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h1 className="font-display mt-4 text-[2.1rem] font-normal leading-[1.05] tracking-[-0.03em] sm:text-[2.5rem] md:text-5xl">Kelola Portfolio</h1>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <Link href="/admin/inquiries" className="rounded-2xl border border-white/10 px-4 py-2 font-mono text-[10px] font-black uppercase tracking-[0.16em] text-white/52 transition duration-300 hover:border-[#D4AF37]/35 hover:text-[#D4AF37]">
                  Inquiry Project
                </Link>
              </div>
            </div>
