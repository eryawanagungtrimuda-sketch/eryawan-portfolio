...
const baseStyles = 'inline-flex items-center justify-center rounded-[4px] px-7 py-4 text-sm font-semibold uppercase tracking-[0.1em] transition duration-300 hover:-translate-y-0.5';
