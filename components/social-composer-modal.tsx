...
export default function SocialComposerModal({ contentType, slug }: Props) {
  ...
  function regenerateMissingCanvaOnly() {
                  ...
                  {activeTab === 'canva' && (
                    <div className="space-y-3">
                      ...
                      <ButtonRow>
                        ...
                        />
                        <button type="button" onClick={regenerateMissingCanvaOnly} className="rounded-full border border-[#D4AF37]/60 bg-[#D4AF37]/10 px-4 py-2 text-sm text-[#E6C676]">{copied.regen ? 'Disalin' : 'Regenerate Missing Canva'}</button>
