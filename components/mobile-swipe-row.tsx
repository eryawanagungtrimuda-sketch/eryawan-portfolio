  ...
  return (
    <div className={`overflow-hidden ${className}`}>
      ...
      <div className="relative">
        <div
          ref={scrollRef}
          className={`mobile-swipe-track no-scrollbar grid grid-flow-col auto-cols-[calc(100%-2rem)] items-stretch snap-x snap-mandatory gap-3.5 overflow-x-auto scroll-smooth scroll-px-4 px-4 pb-6 pt-1 overscroll-x-contain touch-auto sm:auto-cols-[calc(100%-2.5rem)] sm:gap-4 sm:scroll-px-5 sm:px-5 md:auto-cols-[48%] lg:grid lg:grid-flow-row lg:auto-cols-auto lg:overflow-visible lg:px-0 lg:pb-0 lg:pt-0 lg:snap-none ${desktopGridClassName}`}
